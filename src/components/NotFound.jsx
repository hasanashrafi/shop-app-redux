  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="text-center">
        ...
        <a href="/" className=" hover:text-light border border-primary mt-4 inline-block px-6 py-2 text-white bg-blue-500 rounded hover:bg-blue-600 transition duration-300">
          Go Back Home
        </a>
      </div>
    </div>
